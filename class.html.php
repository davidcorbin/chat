            ...
            <form class="form-horizontal" method="post" action="adduser.php" autocomplete="off">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="text" class="form-control" placeholder="Create a username" name="username" autocorrect="off">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <input type="password" class="form-control" placeholder="Create a password" name="password" autocorrect="off">
                  </div>
                </div>
